            ...
            return (
                ...
                <div className="projects-grid">
                    ...
                    <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                        ...
                        <CardText>
                            Some random blob of text for descriptions purposes..
                    </CardText>
                        <CardActions border>
                    ...
                    {/* Project 3 */}
                    <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
                        <CardTitle style={{ color: '#fff', height: '176px', background: 'url(https://www.andreasreiterer.at/wp-content/uploads/2017/11/react-logo-825x510.jpg) center / cover' }}>React Project #3</CardTitle>
                        <CardText>
                            Some random blob of text for descriptions purposes..
                    </CardText>
                        <CardActions border>
    ...
    render() {
        return (
            <div className="category-tabs">
                <Tabs activeTab={this.state.activeTabTab} onChange={(tabId) => this.setState({ activeTab: tabId })} ripple>
                    <Tab>React</Tab>
                    <Tab>Angular</Tab>
                    <Tab>VueJS</Tab>
                    <Tab>MongoDB</Tab>
